...
export const SectionHeader = ({
  ...
  return (
    <div className={`section-header mt-3 md:mt-2 mb-2 md:mb-4 pt-1.5 md:pt-0 text-center ${className}`}>
      ...
      {subtitle && <p className="section-header-subtitle text-[11px] leading-tight md:text-base md:leading-normal text-bloom-sub/80 md:text-bloom-sub mt-0 mb-0 max-w-full mx-auto">{subtitle}</p>}
    </div>
  );
};
