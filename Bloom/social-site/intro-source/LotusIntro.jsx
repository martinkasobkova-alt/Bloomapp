/**
 * Bloom intro animation — SOURCE COPY for social/media export.
 * Original: frontend/src/components/LotusIntro.jsx
 * Shown once per session via sessionStorage 'bloom_intro_shown'.
 * Animation: lotus petals (petalBloom) + "Bloom" / tagline (introWordFade) + full-screen fade-out (introFadeOut).
 * LotusLogo is inlined as SVG in this component; app uses import from Layout.js.
 */
